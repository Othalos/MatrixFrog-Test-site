      ...
      <CardContent className="space-y-6 p-6">
        ...
        <>
            <div className="flex justify-end mb-4">
              <button onClick={handleRefresh} disabled={isRefreshing || isLoading} className="flex items-center gap-2 px-3 py-1 text-xs border border-green-700 rounded-md hover:bg-green-900/50 disabled:cursor-wait disabled:text-gray-500 disabled:border-gray-700">
